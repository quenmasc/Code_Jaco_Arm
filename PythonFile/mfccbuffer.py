...
class MFFCsRingBuffer(object):
        ...
        def __init__(self):
            ...
            self.__SampleRingBuffer=RingBuffer.RingBuffer(24650,200,80)
        ...
        def get(self):
         ...
         #       print "tail :" ,self.__tail , "new value ;" , self.__tail/13 
					return np.concatenate((mfccs_reshape,np.zeros(self.__lengthMax*3-mfccs_reshape.size)),axis=0),self.__SampleRingBuffer.getSegments(len(idx)/13)#self.__tail
